...
$result = $db->query('CREATE TABLE IF NOT EXISTS user_relations (user_id BIGINT UNSIGNED NOT NULL, relation_id BIGINT UNSIGNED NOT NULL, type SMALLINT UNSIGNED NOT NULL)');
